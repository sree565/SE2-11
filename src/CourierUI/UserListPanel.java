...
private DefaultListModel dList;
	...
	public UserListPanel(JFrame currentFrame, ACMECourierCompany company){
		...
		JLabel lblCustomersList = new JLabel("Users List");
		lblCustomersList.setFont(new Font("Tahoma", Font.BOLD, 13));
		...
		btnEdit.setBounds(184, 325, 97, 25);
		add(btnEdit);
		...
		btnDelete.setBounds(319, 325, 97, 25);
		add(btnDelete);
